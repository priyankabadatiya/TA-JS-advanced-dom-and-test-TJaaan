...
test("if guest1 is rock and guests2 is paper then player1 wins", () => {
    expect(getWinner(Paper, Rock)).toBe("Player 1 wins!");
});

test("if guest1 is Paper and guests2 is Paper then player1 wins ", () => {
...
test("if guest1 is Rock and guests2 is Scissors then player1 wins ", () => {
